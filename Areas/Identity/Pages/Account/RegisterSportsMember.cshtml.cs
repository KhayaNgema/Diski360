    ...
    public class RegisterSportsMemberModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var roles = await _roleManager.Roles
                .Where(r => r.Name != "System System Administrator")
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Role == "Division Manager" && Input.DivisionId == null)
                {
                    ModelState.AddModelError("Input.Division", "The Division field is required for Division Managers.");
                ...
                var user = new SportsMember
                {
                    ...
                    DivisionId = Input.Role == "Division Manager" ? Input.DivisionId : divisionId
                };
